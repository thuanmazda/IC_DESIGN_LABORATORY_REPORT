...
\begin{figure}[H]
    ...
    %\includegraphics[width=0.45\textwidth]{figures/not_waveform.png}
    %\includegraphics[width=0.45\textwidth]{figures/or2_waveform.png}
    % ...
...
% LƯU Ý CHO NGƯỜI DÙNG: Cột "Leakage Power" và "Dynamic Power" chưa có số liệu
% riêng lẻ từ file báo cáo. Sau khi có file power.rpt từ Genus, tra cứu hai dòng
% tương ứng rồi thay thế ký hiệu "\ldots" bằng giá trị thực.

\begin{table}[H]
    \centering
    \begin{tabular}{|l|c|c|c|}
        \hline
        \textbf{Library Name} & \textbf{Leakage Power (W)} & \textbf{Dynamic Power (W)} & \textbf{Total Power (W)} \\
        \hline
        fast\_vdd1v0\_basicCells\_hvt & \ldots & \ldots & $5.727\times10^{-8}$ \\ \hline
        fast\_vdd1v2\_basicCells\_hvt & \ldots & \ldots & $8.441\times10^{-8}$ \\ \hline
        slow\_vdd1v0\_basicCells\_hvt & \ldots & \ldots & $4.932\times10^{-8}$ \\ \hline
        slow\_vdd1v2\_basicCells\_hvt & \ldots & \ldots & $7.492\times10^{-8}$ \\ \hline
        fast\_vdd1v0\_basicCells\_lvt & \ldots & \ldots & $7.235\times10^{-8}$ \\ \hline
        fast\_vdd1v2\_basicCells\_lvt & \ldots & \ldots & $1.047\times10^{-7}$ \\ \hline
        slow\_vdd1v0\_basicCells\_lvt & \ldots & \ldots & $5.757\times10^{-8}$ \\ \hline
        slow\_vdd1v2\_basicCells\_lvt & \ldots & \ldots & $8.605\times10^{-8}$ \\ \hline
    \end{tabular}
